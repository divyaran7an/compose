...
import { Bot, Wallet, Send, User, Zap, TrendingUp, DollarSign, Copy, AlertCircle, Activity, Shield, ExternalLink } from 'lucide-react';
...
export default function SolanaAgent() {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch('/api/solana-agent', {
        method: 'POST',
        headers: {
  ...
  const quickActions = [
    { icon: Wallet, text: 'Check SOL balance', action: 'Check my SOL balance' },
    { icon: DollarSign, text: 'Get SOL price', action: 'Get price of SOL' },
    { icon: Send, text: 'Transfer tokens', action: 'Transfer 0.1 SOL to...' },
    { icon: TrendingUp, text: 'Swap SOL/USDC', action: 'Swap 0.1 SOL for USDC' }
  ];
          ...
          <div className="mx-auto max-w-6xl text-center">
            <h1 className="font-heading text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
              <span className="bg-gradient-to-b from-white to-zinc-400 bg-clip-text text-transparent">
                Ship Solana Agent Kit Apps
              </span>
            </h1>
            <p className="mt-6 max-w-2xl mx-auto text-lg text-zinc-400 md:text-xl">
              Everything's configured. Agent wallet ready. Execute Solana transactions instantly.
            </p>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription className="text-zinc-400">
                      Advanced Solana assistant • Transfer tokens, check balances, swap assets, and more
                    </CardDescription>
                  </div>
              ...
              <CardContent className="flex-1 p-4 overflow-hidden flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto pr-2 space-y-4">
                  {messages.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-full text-center p-8">
                      ...
                      <h3 className="text-lg font-medium text-zinc-200 mb-2">Ready to interact</h3>
                      <p className="text-sm text-zinc-400 max-w-sm mb-6">
                        I can help you with Solana operations. Try the quick actions below to get started!
                      </p>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="bg-zinc-800 text-zinc-100 px-4 py-2 rounded-2xl">
                            <div className="flex items-center gap-2">
                              <span className="text-sm">Processing Solana transaction</span>
                ...
                <form onSubmit={onSubmit} className="mt-4 flex gap-2">
                  <Input
                    ...
                    placeholder="Ask me to transfer tokens, check balances, or swap assets..."
                    disabled={isLoading}
            ...
            <Card className="border-zinc-800 bg-zinc-900/50 backdrop-blur">
              <CardContent className="pt-6">
                <div className="grid gap-4 md:grid-cols-2">
                  <div>
                    <h3 className="font-medium text-sm mb-3">Token Operations</h3>
                  ...
                  <div>
                    <h3 className="font-medium text-sm mb-3">Trading & Market Data</h3>
                    <div className="space-y-2">
                      <div className="flex items-center gap-2 text-xs text-zinc-400">
                ...
                <div className="mt-4 p-3 bg-zinc-800/50 rounded-lg">
                  <div className="flex items-start gap-2">
                    <ExternalLink className="h-3 w-3 text-zinc-400 mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="text-xs text-zinc-300 mb-1">Expand your agent</p>
                      <p className="text-xs text-zinc-500">
                        Install additional plugins from{' '}
                        <a 
                        ...
                        {' '}for NFT operations, DeFi, staking, and more.
                      </p>
                    </div>
                  </div>
                </div>
                <p className="text-center text-xs text-zinc-500 mt-4">
                  🛡️ Running on Solana devnet for safe experimentation
                </p>
              </CardContent>
            </Card>
          </div>
