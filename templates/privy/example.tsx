...
import PrivyWrapper from '../lib/privy/config';
...
import { Sparkles, Mail, Wallet, Shield, Zap, Copy, CheckCircle } from 'lucide-react';
...
export default function PrivyDemo() {
  ...
  const isConfigured = !!process.env.NEXT_PUBLIC_PRIVY_APP_ID;

  return (
    <>
      <Head>
        <title>Privy Demo - Email Auth & Embedded Wallet</title>
        <meta name="description" content="Simple Privy integration with email authentication and embedded wallet" />
      </Head>
            ...
            <div className="mx-auto max-w-6xl text-center">
              <h1 className="font-heading text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
                <span className="bg-gradient-to-b from-white to-zinc-400 bg-clip-text text-transparent">
                  Ship Apps with Privy
                </span>
              </h1>
              <p className="mt-6 max-w-2xl mx-auto text-lg text-zinc-400 md:text-xl">
                Privy authentication configured. Embedded wallets ready. Deploy Web3 apps instantly.
              </p>
                  ...
                  <AlertDescription className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                      ...
                      <p className="text-zinc-400">
                        Copy sample.env to .env.local and add your Privy App ID from{' '}
                        <a href="https://dashboard.privy.io" target="_blank" rel="noopener noreferrer" className="text-white underline">
                          dashboard.privy.io
                        </a>
                      </p>
                    </div>
            ...
            <div className="mx-auto max-w-4xl">
              <Alert className="border-zinc-800 bg-zinc-900/50">
                ...
                <AlertDescription className="text-zinc-300">
                  <strong>Powered by Privy:</strong> This demo showcases Privy's email authentication and embedded wallet functionality. 
                  All authentication and wallet operations are handled securely by Privy's infrastructure.
                </AlertDescription>
              </Alert>
            </div>
          </section>
